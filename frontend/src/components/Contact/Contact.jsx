          ...
          >
            <div className="contact__info-item">
              ...
              <div>
                ...
                <a href="mailto:your@email.com" className="contact__info-value">hibatullahabdulazeez@email.com</a>
              </div>
            </div>
            ...
            <div className="contact__info-item">
              ...
              <div>
                ...
                <p className="contact__info-value">Ekiti, Nigeria</p>
              </div>
            </div>

            <div className="contact__socials">
              <a href="https://github.com/gift114" target="_blank" rel="noreferrer" className="contact__social-btn">
              ...
              <a href="https://www.linkedin.com/in/hibatullah-abdulazeez-a25783375?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" className="contact__social-btn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
